...
#include "server/InterServerConnection.h"
...
class TestClientConnection : public InterServerConnection {
  public:
...
int main()
{
    InterServerConnection * cc = new InterServerConnection();
    delete cc;

    // Try all the method calls when not connected
    cc = new InterServerConnection();

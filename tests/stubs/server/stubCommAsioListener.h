...
//#define STUB_CommAsioListener_CommAsioListener
  template <typename ProtocolT,typename ClientT>
   CommAsioListener<ProtocolT,ClientT>::CommAsioListener(std::function<void(ClientT&)> clientStarter, const std::string& serverName, boost::asio::io_context& ioService, const typename ProtocolT::endpoint& endpoint)
  {

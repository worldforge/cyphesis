...
//#define STUB_ArchetypeFactory_createEntity
  Ref<LocatedEntity> ArchetypeFactory::createEntity(const std::string& id, long intId, EntityCreation& entityCreation, std::map<std::string, EntityCreation>& entities)
  {

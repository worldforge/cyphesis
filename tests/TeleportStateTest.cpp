...
{
    {
        TeleportState * ts = new TeleportState(boost::posix_time::microsec_clock::local_time());

        delete ts;
    }

    {
        auto create_time = boost::posix_time::microsec_clock::local_time() + boost::posix_time::seconds(23);

...
class EntityImporterBase : public virtual sigc::trackable
{
    public:
        ...
        /**
         * @brief Sets if we also should suspended the world when importing.
         * @param enabled True if we should suspend.
         */
    ...
    protected:
        ...
        /**
       * @brief True if we also should suspend the world when importing.
       */
        bool mSuspendWorld;

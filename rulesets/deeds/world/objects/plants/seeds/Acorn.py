...
class Acorn(Seed):
    ...
    def germinate_operation(self, op):
        ...
        create_ent=Entity(name='oak',parent='oak',location=Location(self.location.parent, self.location.coordinates),mass=self.props.mass,bbox=[-0.02, -0.02, 0, 0.02, 0.02, 0.12])

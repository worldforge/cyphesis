...
village_height=0
forest_height=0
smithy_xyz=(-5,-130,village_height)
forest_xyz=(-20,-160,village_height)
tavern_xyz=(40,-100,village_height)
market_xyz=(-20,-110,village_height)
tree_xyz=(-35,-125,village_height)
...
knowledge=[('axe','smithy'),
           ...
           ('tavern',tavern_xyz),
           ('market',market_xyz)]
bknowledge=[('market',market_xyz)]
sknowledge=[('forest',(-30,-116,village_height)),
            ('stash',(-30,-113,village_height))]


goals=[(il.breakfast,"imaginary('have a breakfast', 'morning', 'home')"),
       (il.lunch,"imaginary('have a lunch', 'midday', 'home')"),
       (il.sup,"imaginary('have a supper', 'evening', 'home')"),
       (il.sleep,"imaginary('sleep good night', 'night', 'home')"),
       (il.build_home,"build_home")]

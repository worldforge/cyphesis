...
class CommAdminClient : public CommClient<unix_socket_stream> {
  public:
    CommAdminClient(CommServer &, const std::string &, int fd);
    virtual ~CommAdminClient();
};

#endif // SERVER_COMM_ADMIN_CLIENT_H

                                          ...
                                          std::string & reason)
{
    ...
    if (populateArchetypeFactory(class_name, factory,
                                         ...
                                         const Root & class_desc)
{
    ...
    if (factory->m_parent != 0) {
        ...
        log(ERROR, compose("ArchetypeRuleHandler::modifyEntityClass: \"%1\" modified "
...
int ArchetypeRuleHandler::populateArchetypeFactory(const std::string & class_name,
                                             EntityKit * factory,
